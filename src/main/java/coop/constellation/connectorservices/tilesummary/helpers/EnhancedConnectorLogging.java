package coop.constellation.connectorservices.tilesummary.helpers;
 ...
 * application.properties settings: EnhancedConnectorLogging = true in the global params will
...
public class EnhancedConnectorLogging extends ConnectorLogging {
     ...
     * global connector param, 'EnhancedConnectorLogging' EnhancedConnectorLogging = true --> logging is turned
     * on. EnhancedConnectorLogging = false (or any other value) --> logging is turned off. If the
